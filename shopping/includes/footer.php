...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="https://www.facebook.com/ravi.beniwal.1272" class='active'><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 8559088130<br>(+91) 7696338489</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">RAVIBENIWAL35@GMAIL.COM</a></span>
                </div>
            </li>
